 ...
 */
function beauty_fashion_preprocess_page(&$vars) {
    if (arg(0) == 'crm_pages') {
        if (!arg(1)) {
 ...
 *   An array of variables to pass to the theme template.
 */
function beauty_fashion_preprocess_html(&$vars) {
...
function beauty_fashion_add_normal_js() {

  
  beauty_add_js(drupal_get_path('theme', 'beauty_fashion') . '/js/util/jquery.mobile-1.3.0.min.js');
