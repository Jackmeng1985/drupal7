...
<html>
  ...
  <body>
    <div class="content">
      <div class="banner">
        <a href="/world_cup/detail"><img src="<?php print $base_path . $directory; ?>/images/banner2.jpg" alt=""></a>
        <div class="banner-title">
          <span class="pull-left">【丽锦嗨时尚独家】真心跪了！梅西球迷，你们太强了！</span>
        </div>
      </div>
      <!-- end banner content -->
        ...
        <li class="table-view-cell">
          <div class="">
            <div class="table-view-des">
              没有内马尔的洗剪吹，也没有C罗3场换了3个发型为自己造势，梅西之所以被称为球王靠的绝对是实力呀！这位低调的世界球星无论出现在哪里，都能萌化一群球迷的心。
